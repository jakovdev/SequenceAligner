 ...
 * print(M_NONE, VERBOSE "Batch size: %zu tasks per batch", batch_size);
 ...
 *
 * print_dev("Error: %d", value);
 **│ ✗ _TO_DEV_ | Error: 42                                                       │
 **Only prints in debug builds (NDEBUG not defined) with error context _TO_DEV_
 *
 **Close section (will do it automatically on exit or new section/header)
 * print(M_NONE, NULL);
 **└──────────────────────────────────────────────────────────────────────────────┘
 *
