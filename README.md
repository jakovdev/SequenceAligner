...
> [!NOTE]
> Smith-Waterman and Gotoh algorithms are approximately 2-3x slower than Needleman-Wunsch. Building aligned strings with gap characters adds ~5-10ms to processing time.
...
- **Input**: CSV file with sequences
  - Default format assumes sequence in first column
  - Configurable column position via command line options
  - Will add auto-detect later
